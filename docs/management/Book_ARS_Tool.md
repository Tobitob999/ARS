...
**Parallel anwenden mit:** [WCR.md](WCR.md) (Schema-Referenz)
...
**Prinzip:** Das universelle Regelgeruest in [WCR.md](WCR.md) Sektion 3 definiert **alle moeglichen Felder**. Dieses Dokument beschreibt, **wie** ein Buch darauf abgebildet wird.
...
Lade vor Beginn:
1. [WCR.md](WCR.md) — Schema-Referenz (insbesondere Sektion 3: Skeleton-Baum)
...
4. [agents.md](agents.md) — Codex-Richtlinien und Namenskonventionen
